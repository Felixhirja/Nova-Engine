...
tests/test_solar_system: tests/test_solar_system.cpp src/SolarSystem.cpp src/CelestialBody.cpp src/Transform.cpp src/ecs/EntityManager.cpp src/Mesh.cpp tests/gl_stub.cpp
	$(CXX) $(CXXFLAGS) -Isrc/glad/include -I./src -o $@ tests/test_solar_system.cpp src/SolarSystem.cpp src/CelestialBody.cpp src/Transform.cpp src/ecs/EntityManager.cpp src/Mesh.cpp tests/gl_stub.cpp $(LDLIBS)
