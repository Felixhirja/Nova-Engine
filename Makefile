...
tests/test_solar_system: tests/test_solar_system.cpp src/SolarSystem.cpp src/CelestialBody.cpp src/Transform.cpp src/ecs/EntityManager.cpp src/Mesh.cpp tests/gl_stub.cpp
	$(CXX) $(CXXFLAGS) -Ilib/glad/include -I./src -o $@ tests/test_solar_system.cpp src/SolarSystem.cpp src/CelestialBody.cpp src/Transform.cpp src/ecs/EntityManager.cpp src/Mesh.cpp tests/gl_stub.cpp $(LDLIBS)

tests/test_animation_system: tests/test_animation_system.cpp $(filter-out src/main.o,$(OBJ))
	$(CXX) $(CXXFLAGS) -I./src -o $@ tests/test_animation_system.cpp $(filter-out src/main.o,$(OBJ)) $(LDLIBS)
