...
tests/test_camera_presets: tests/test_camera_presets.cpp $(filter-out engine/main.o,$(OBJ)) $(GLAD_OBJ)
	$(CXX) $(CXXFLAGS) -I./engine -o $@ tests/test_camera_presets.cpp $(filter-out engine/main.o,$(OBJ)) $(GLAD_OBJ) $(LDLIBS)
